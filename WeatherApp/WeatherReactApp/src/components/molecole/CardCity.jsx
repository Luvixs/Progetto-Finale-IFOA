...
const CardCity = (prop) => {
  ...
  return (
    <Container className="mt-4 " fluid>
      <Row className="  flex-xl-row justify-content-center flex-column align-items-start">
        <Col className="fs-4 mt-2 text-start" xs={4} xl={4}>
        ...
        <Col className="fs-4 mt-2" xs={12} xl={6}>
          <NextDays
            className="mt-5"
        ...
        <Col xs={4} xl={5} style={{width:"100vw", height:"300px"}}>
          ...
          <ResponsiveContainer>
            ...
            >
              ...
              <XAxis dataKey="time" /> <YAxis dataKey="temperature"/>
